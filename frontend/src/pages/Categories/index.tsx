  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-wrap items-end justify-between gap-3">
        <div>
          <h1 className="text-[26px] font-bold leading-[1.08] text-slate-900">
            Categorias
          </h1>
            ...
            return (
              ...
              >
                ...
                <div className="mt-6 flex items-center justify-between">
                  <span
                    className={`inline-flex rounded-full px-3 py-1 text-sm ${palette.badge} text-[12px]`}
                  >
                    {category.title}
                  </span>
                  <span className="text-sm text-slate-600 text-[12px]">
